(function( $ ) {
    ...
    // $(function() {
    //     // $("#ud_mp_hide_subs").focusout(function(e){
    //     // $('#user_directory_options_submit').submit(function(){
    //     // $('#ud_mp_hide_subs').change(function(e) {
    //     $("#user_directory_options").on("submit", function(e) {
    //         // e.preventDefault();
    //         SWAPLIST.invert($('#ud_mp_hide_subs'));
    //     });
    // });
